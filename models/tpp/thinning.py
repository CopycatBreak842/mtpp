...
class EventSampler(nn.Module):
    ...
    def draw_next_time_ordinary(self, arguments, fastapprox=True):
        batch, time_last_event, boundary, compute_intensity_fn = arguments
        ...
        intensities_for_bound = compute_intensity_fn(event_seq,
                                                     time_seq,
        ...
        intensities_at_sampled_times = compute_intensity_fn(event_seq, time_seq, sampled_times)
